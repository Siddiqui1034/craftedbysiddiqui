...
//         <p className="text-sm font-xl">Development</p>
//         <p className="text-2xl font-bold text-white hover:text-rose-600">My Portfolio<br />of Innovation</p>
//       </div>
...
//           {/* <ArrowRightOutlined className="w-5 h-5 text-black" /> */}
//                 <FontAwesomeIcon icon={faExternalLink} className="w-5 h-5  text-white"/>
//         </div>
//       </div>
//     </div>
//   );
    ...
    <div>
      <div className="space-y-6">
       ...
       <div  className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <WorkCard image="/images/tab-image-1.png" />
        <WorkCard image="/images/tab-image-2.png" />
        <WorkCard image="/images/tab-image-3.png" />
        <WorkCard image="/images/tab-image-4.png" />
        <WorkCard image="/images/tab-image-5.png" />
        <WorkCard image="/images/tab-image-6.png" />
       </div>
      </div>
    </div>
  );
